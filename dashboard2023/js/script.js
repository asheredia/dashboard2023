...
AWS.config.credentials = new AWS.CognitoIdentityCredentials({
    IdentityPoolId: 'us-east-1:9dd4c79f-b7a7-453a-83cd-2e730439d211',
});
        ...
        if (err) {
            ...
            stations.forEach(function (id) {
                ...
                var params = {
                    ...
                    ProjectionExpression: "#dtime, temperature, humidity, rainHeight, soilMoisture",
                ...
                docClient.query(params, function (err, data) {
                    if (err) {
                        ...
                        document.getElementById('latest-value4').innerHTML = latest.soilMoisture + ' %';
                        ...
                        /*for (c = 1; c < 5; c++) {       //previous value: 6
                        ...
                        //}
                        for (c = 0; c < 5; c++) {
                            document.getElementById('station1').innerHTML += '<tr><td>' + actual[c].datetime + '</td><td>' + actual[c].temperature + '</td><td>' + actual[c].humidity + '</td><td>' + actual[c].rainHeight + '</td><td>' + actual[c].soilMoisture + '</td></tr>';
